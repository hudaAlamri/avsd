...
parser.add_argument('--load_path', default='/nethome/halamri3/cvpr2020/avsd/checkpoints/nofinetune/14-Nov-2020-18:38:1/model_final.pth', help='Checkpoint to load path from')
